# Este es el back-end de la aplicación para buscar precios de productos de consumo masivo en una base de datos de comercios previamente cargados.
## Herramientas:
...
### Desarrollo Backend con __NodeJS__ , **Express**, **MongoDB**, **Mongoose**, **Cors** y **Morgan**.
...
### El frontend de este proyecto se puede obtener clonando el siguiente repo al ejecutar el comando de abajo:
